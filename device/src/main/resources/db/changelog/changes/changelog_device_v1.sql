...
(
    DEVICE_SETTINGS_ID        BIGINT AUTO_INCREMENT PRIMARY KEY,
    TIME_INTERVAL             INT(10) DEFAULT 360000,
...
(
    ...
    CONSTRAINT fk_devices_device_settings FOREIGN KEY (SETTINGS_ID) REFERENCES DEVICE_SETTINGS(DEVICE_SETTINGS_ID)
);