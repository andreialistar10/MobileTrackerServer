...
@Component
public class MailSenderImpl implements UserAccountMailSender {
    ...
    public MailSenderImpl(JavaMailSender javaMailSender, Configuration configuration, NotActivatedAccountDao notActivatedAccountDao) {
    ...
    @Transactional
    @Override
    public void sendMail(MailUserDetails mailUserDetail) {
